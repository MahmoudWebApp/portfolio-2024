...
export default function Home() {
  return (
    <motion.div className="h-full" initial={{ y: "-200vh" }} animate={{ y: "0%" }} transition={{ duration: 1 }}>
      <div className="h-full flex lg:flex-row flex-col px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 md:gap-12 gap-6">
        {/* Image container */}
        <div className="h-[35%] lg:h-full lg:w-1/2 relative">
          <Image src="/assets/hero.png" fill alt="" className="object-contain" />
        </div>
        {/* Text container */}
        <div className="h-[65%] lg:h-full lg:w-1/2 flex flex-col lg:gap-8 gap-6 items-center justify-center text-black">
